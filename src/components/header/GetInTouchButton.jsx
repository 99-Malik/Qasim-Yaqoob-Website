...
const GetInTouchButton = ({
  ...
  let color = "#1D4ED8"; // Default blue for primary
  ...
  return (
    <motion.button
      ...
      className={cn(
        `flex items-center justify-center gap-3 rounded-md border-[0.6px] bg-white px-5 py-3 transition-all`,
        className
      )}
      style={{
        borderColor: color,
...
const PhoneIcon = ({ strokeColor = "#0F2C4A" }) => (
  <motion.svg
    width="23"
    height="23"
    viewBox="0 0 23 23"
