...
const PortfolioMain = () => {
  return (
    <section className="relative flex min-h-[20rem] w-full flex-col items-center justify-center gap-3 px-5 text-center md:min-h-[40rem] md:gap-5">
      <h1 className="text-3xl font-medium md:text-6xl">Our Portfolio</h1>
      <span className="max-w-5xl text-custom-black/70 md:text-2xl md:leading-normal">
        We are versatile creative service providers specializing in web and app{" "}
        <br />
        development, graphic design, video editing, and social media branding.
