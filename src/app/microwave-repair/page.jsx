...
export default function MicrowaveRepairPage() {
  const services = [
    {
      icon: Zap,
      title: "Magnetron Issues",
      description: "Repair magnetron problems, heating issues, and power supply faults.",
      features: ["Magnetron Replacement", "Heating Problems", "Power Supply", "High Voltage"]
    },
    {
      icon: Wrench,
      title: "Door Problems",
      description: "Fix door latch issues, door switches, and safety interlock problems.",
      features: ["Door Latch Repair", "Door Switches", "Safety Interlock", "Door Alignment"]
    },
    {
      icon: Shield,
      title: "Electronic Controls",
      description: "Repair control panel issues, programming problems, and electronic faults.",
      features: ["Control Panel Repair", "Programming Issues", "Display Problems", "Button Replacement"]
    },
    {
      icon: Clock,
      title: "Turntable Issues",
      description: "Fix turntable motor problems, drive system, and rotation issues.",
      features: ["Turntable Motor", "Drive System", "Rotation Problems", "Bearing Replacement"]
    }
  ];

  const brands = [
    "Samsung", "LG", "Panasonic", "Sharp", "Whirlpool", "GE", "KitchenAid", "Bosch", "Siemens", "Electrolux"
  ];
  ...
  const benefits = [
    {
      ...
      description: "Most microwave repairs completed on the same day"
    },
    {
      icon: Shield,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 mt-12">
      ...
      <section className="relative py-20 px-4 bg-gradient-to-br from-gray-900 via-emerald-900 to-teal-900 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            Professional microwave repairs for all major brands and models
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional repairs for all types of microwaves
            </p>
          </motion.div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Why Choose Our Microwave Repair?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-emerald-600 to-teal-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Get professional microwave repair services for any brand or model
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
