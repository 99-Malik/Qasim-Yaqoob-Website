...
export default function DishwasherRepairPage() {
  const services = [
    ...
    },
    {
      ...
      description: "Repair drain pump problems, clogged drains, and drainage system issues.",
      features: ["Drain Pump Replacement", "Clog Removal", "Drain Hose Repair", "Filter Cleaning"]
    },
    {
      icon: Shield,
      title: "Cleaning Systems",
      description: "Fix spray arm problems, detergent dispensers, and cleaning cycle issues.",
      features: ["Spray Arm Repair", "Detergent Dispenser", "Cleaning Cycle", "Rinse Aid System"]
    },
    {
      icon: Clock,
  ...
  const brands = [
    "Bosch", "Siemens", "Samsung", "LG", "Whirlpool", "Maytag", "KitchenAid", "GE", "Electrolux", "Miele"
  ];
  ...
  const benefits = [
    {
      ...
      description: "Most dishwasher repairs completed on the same day"
    },
    {
      icon: Shield,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 mt-12">
      ...
      <section className="relative py-20 px-4 bg-gradient-to-br from-violet-950 via-purple-900 to-indigo-950 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            Professional dishwasher repairs for Bosch, Siemens, Samsung, LG, and all major brands
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional repairs for all types of dishwashers
            </p>
          </motion.div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Why Choose Our Dishwasher Repair?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
