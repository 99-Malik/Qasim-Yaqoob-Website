          ...
          <div className="flex w-full max-w-7xl flex-col items-center gap-5 self-center px-5 py-20 md:flex-row">
            ...
            <div className="flex flex-col gap-5">
              ...
              <h2 className="mb-3 text-custom-black/70 md:text-xl">
                ...
                certified technicians provide reliable, efficient repairs for
                all your home appliances, ensuring minimal disruption to your
                daily life with quick turnaround times and quality service.
              </h2>
              <Link href="/contact">
            ...
            <div className="grid w-full max-w-7xl gap-10 px-6 py-20 md:grid-cols-[5.2fr_4.8fr]">
              <div className="flex flex-col gap-5">
                ...
                <h2 className="mb-3 text-custom-black/70 md:text-xl">
                  ...
                  reliable, efficient repairs for all your home appliances,
                  ensuring minimal disruption to your daily life with quick
                  turnaround times and quality service.
                </h2>
                <Link href="/contact">
                  <PrimaryButton title="Schedule Service" className="w-fit" />
                </Link>
