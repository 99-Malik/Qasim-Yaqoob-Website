  ...
  const benefits = [
    {
      ...
      description: "Most oven repairs completed on the same day"
    },
    {
      icon: Shield,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 mt-12">
      ...
      <section className="relative py-20 px-4 bg-gradient-to-br from-violet-950 via-purple-900 to-indigo-950 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            Professional oven and stove repairs for all major brands and models
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional repairs for all types of ovens, stoves, and ranges
            </p>
          </motion.div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Why Choose Our Oven & Stove Repair?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-rose-500 via-pink-600 to-purple-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Get professional oven and stove repair services for any brand or model
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
